...
API_ID = 23136983
API_HASH = "f10305215256525bc2b9f2d8a4e9a4ac"
BOT_TOKEN = "5841168818:AAGTDTKHOi8BWYG-SveHsxUPvA2qoRbA6BI"
AUTH_USERS = 5361994895
sudo_users = [6128917383]
bot = Client(
    "bot",
    bot_token=BOT_TOKEN,
    api_id=API_ID,
...
async def account_login(bot: Client, m: Message):
 editable = await m.reply_text("**Hi BOSS I'm Alive Send /down for khan sir  download and for classplus send /cpd  for /dhurina for /vision**")
